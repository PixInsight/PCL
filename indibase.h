...
public:
    ...
    */
    virtual void newDevice(INDI::BaseDevice *dp){(void) dp;};//  =0;

    /** \brief Emmited when a new property is created for an INDI driver.
        \param property Pointer to the Property Container

    */
    virtual void newProperty(INDI::Property *property){(void) property;};//  =0;
    ...
    */
    virtual void newMessage(INDI::BaseDevice *dp, int messageID){(void) dp; (void) messageID;};// =0;
    ...
    */
    virtual void serverDisconnected(int exit_code){(void) exit_code;};// =0;
